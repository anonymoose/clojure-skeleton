...
psql -U postgres -c "create user myproject with password 'myproject';"
psql -U postgres -c "alter database myproject owner to myproject;"
psql -U postgres -d myproject -c 'create extension "hstore";'
psql -U postgres -d myproject -c 'create extension "fuzzystrmatch";'

psql -U myproject -d myproject -f doc/schema.sql
*/
