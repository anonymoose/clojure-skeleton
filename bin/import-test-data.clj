(use '[myproject.model.user :as user])
(use '[myproject.lib.db                 :only [connect-db wrap-transaction]])
(use '[korma.db :as db])
...
(genusr "Ken" "Smith" "USER")
(genusr "Amy" "Smith" "USER")
(genusr "Zach" "Smith" "USER")
(genusr "Aubrey" "Smith" "USER")
